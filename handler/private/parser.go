...
// ParseToggleIsPrivate parses request body.
func ParseToggleIsPrivate(ctx *gin.Context, reqc chan<- APIToggleIsPrivateReq, errc chan<- error) {
	defer close(reqc)
